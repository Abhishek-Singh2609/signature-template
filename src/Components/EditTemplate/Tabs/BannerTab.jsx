    ...
    <div className="banner-tab-form">
      <div className="banner-tab-section">
        ...
        {formData.campaigns.map((campaign) => (
          <div 
            key={campaign.id} 
            className={`banner-tab-campaign-item ${campaign.active ? 'active' : ''}`}
          >
            ...
            <div className="banner-tab-links-section">
              <label className="banner-tab-links-header">Banner Links (Clickable Areas)</label>
            ...
            <div className="banner-tab-footer">
              ...
              <button
                className={`banner-tab-toggle-btn ${campaign.active ? 'active' : ''} ${(!campaign.image || isCampaignExpired(campaign.expiryDate, campaign.startDate)) ? 'disabled' : ''}`}
