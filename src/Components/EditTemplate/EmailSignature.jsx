        ...
        return (
          <div className="form">
            <div className="image-upload-section">
              ...
              <p className="image-tip">Recommended: Banner should be 600px wide and up to 200px tall</p>
            </div>
...
//                 />
//               </div>
//               <p className="image-tip tip-fix">Recommended: Image at least should be 100x100px</p>
//             </div>
...
//         <div className="form-section">
//           <div className="tabs">
//             {["Personal Info", "Images", "Social", "Design"].map((tab) => (
//               <button
//                 key={tab}
//                 className={`tab ${activeTab === tab ? "active" : ""}`}
//                 onClick={() => setActiveTab(tab)}
